...
export declare class Cache {
    ...
    getFeesHistory(newestBlock: string | number, blockCount: number, rewardPercentiles: number[], fetch: () => Promise<Connex.Thor.Fees.History>): Promise<Connex.Thor.Fees.History>;
